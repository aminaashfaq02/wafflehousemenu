        ...
        <div>
          ...
          <ul className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 text-sm">
            {[
              ...
              { to: "/reservations" as const, label: "Reservations & Table Seating Guide" },
              { to: "/recipes" as const, label: "Copycat Diner Recipes" },
              { to: "/gift-cards" as const, label: "Gift Cards & Balance Guide" },
              { to: "/locations" as const, label: "Locations Directory" },
              { to: "/blog" as const, label: "Diner Journal & Blog" },
              { to: "/delivery" as const, label: "Delivery & Takeout Information" },
              { to: "/catering" as const, label: "Catering & Group Ordering Guide" },
              { to: "/happy-hour" as const, label: "Happy Hour & Promotions Guide" },
